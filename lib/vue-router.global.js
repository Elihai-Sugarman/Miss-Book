        ...
        for (const segment of segments) {
            ...
            for (
                ...
                let subSegmentScore =
                    ...
                    (options.sensitive
                        ? 0.25 /* PathScore.BonusCaseSensitive */
                        : 0)
    ...
    function createRouterMatcher(routes, globalOptions) {
        ...
        function resolve(location, currentLocation) {
            ...
            if ('name' in location && location.name) {
                ...
                {
                    const invalidParams = Object.keys(
                        location.params || {}
                    ).filter(
                        (paramName) =>
        ...
        setupDevtoolsPlugin(
            ...
            (api) => {
                ...
                function refreshRoutesView() {
                    ...
                    payload.rootNodes = routes.map(
                        formatRouteRecordForInspector
                    )
                }
    ...
    function createRouter(options) {
        ...
        function resolve(rawLocation, currentLocation) {
            ...
            if (typeof rawLocation === 'string') {
                ...
                const href = routerHistory.createHref(
        ...
        function navigate(to, from) {
            ...
            const canceledNavigationCheck =
                checkCanceledNavigationAndReject.bind(null, to, from)
                ...
                if (replace || isFirstNavigation)
                    routerHistory.replace(
                        ...
                        assign(
                            {
                                scroll:
                                    isFirstNavigation && state && state.scroll,
                            },
                            data
                        )
                    )
        ...
        const router = {
            ...
            install(app) {
                ...
                for (const key in START_LOCATION_NORMALIZED) {
                    ...
                    reactiveRoute[key] = vue.computed(
